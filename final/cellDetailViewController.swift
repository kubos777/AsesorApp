...
class cellDetailViewController: UIViewController {
    ...
    @IBOutlet weak var correoOutlet: UILabel!
    @IBOutlet weak var nombreOutlet: UILabel!
    ...
    override func viewDidLoad() {
        ...
        nombreOutlet.text = publicacion.usuario.nombre
        correoOutlet.text = publicacion.usuario.correo
